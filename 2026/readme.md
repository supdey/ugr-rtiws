...
2. Lab-2: KG concept linking in NER
   * Make a **copy** of the lab [Jupyter notebook](https://colab.research.google.com/drive/1qrugdtmFsdLmEyO-sg_JeUWlehpvAL1M#scrollTo=VCG87TpZAj0u) into your ***own*** Google Drive. Then, launch the Jupyter Notebook from Google Drive in a browser window as we will be using Google Colab for this exercise.
   * [Jupyter notebook](https://colab.research.google.com/drive/1qrugdtmFsdLmEyO-sg_JeUWlehpvAL1M#scrollTo=VCG87TpZAj0u)
   * Resources:
